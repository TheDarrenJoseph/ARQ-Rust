...
pub fn build_library() -> [TileDetails; 9] {
    [
        ...
        TileDetails {id: 3,     tile_type:  Tile::Wall,     traversable: true, symbol: '#', colour: Colour::Brown, name:  "Wall".to_string()},
        TileDetails {id: 4,     tile_type:  Tile::Window,     traversable: true, symbol: '%', colour: Colour::Cyan, name:  "Window".to_string()},
